  ...
  return (
    ...
    <div className='z-40 relative'>
      <div className='w-full flex flex-row fixed bg-black h-16 border-b border-slate-400 border-opacity-25'>
           ...
           <input 
                className='ms-[620px] w-[350px] my-4 h-8 bg-zinc-800 rounded-md'
                type="text"
    ...
    <div className='w-5/6 my-12 bg-black ms-24 h-[450px]'> 
      {cocktailIngredients.length > 0 && a!="a" && (
        <div className=' grid grid-cols-2'>
         ...
         <div className='flex flex-row justify-center space-x-2 my-5 border-b border-white h-14 col-span-2'>
          ...
          <div className= ' border-2 border-white w-7 h-7 rounded-full text-center align-middle'>B</div>
          <div className= ' border-2 border-white w-7 h-7 rounded-full text-center align-middle'>C</div>
          <div className= ' border-2 border-white w-7 h-7 rounded-full text-center align-middle'>D</div>
          <div className= ' border-2 border-white w-7 h-7 rounded-full text-center align-middle'>E</div>
          <div className= ' border-2 border-white w-7 h-7 rounded-full text-center align-middle'>F</div>
          <div className= ' border-2 border-white w-7 h-7 rounded-full text-center align-middle'>G</div>
          <div className= ' border-2 border-white w-7 h-7 rounded-full text-center align-middle'>H</div>
          <div className= ' border-2 border-white w-7 h-7 rounded-full text-center align-middle'>I</div>
          <div className= ' border-2 border-white w-7 h-7 rounded-full text-center align-middle'>J</div>
          <div className= ' border-2 border-white w-7 h-7 rounded-full text-center align-middle'>K</div>
          <div className= ' border-2 border-white w-7 h-7 rounded-full text-center align-middle'>L</div>
          <div className= ' border-2 border-white w-7 h-7 rounded-full text-center align-middle'>M</div>
          <div className= ' border-2 border-white w-7 h-7 rounded-full text-center align-middle'>N</div>
          <div className= ' border-2 border-white w-7 h-7 rounded-full text-center align-middle'>O</div>
          <div className= ' border-2 border-white w-7 h-7 rounded-full text-center align-middle'>P</div>
          <div className= ' border-2 border-white w-7 h-7 rounded-full text-center align-middle'>Q</div>
          <div className= ' border-2 border-white w-7 h-7 rounded-full text-center align-middle'>R</div>
          <div className= ' border-2 border-white w-7 h-7 rounded-full text-center align-middle'>S</div>
          <div className= ' border-2 border-white w-7 h-7 rounded-full text-center align-middle'>T</div>
          <div className= ' border-2 border-white w-7 h-7 rounded-full text-center align-middle'>U</div>
          <div className= ' border-2 border-white w-7 h-7 rounded-full text-center align-middle'>V</div>
          <div className= ' border-2 border-white w-7 h-7 rounded-full text-center align-middle'>W</div>
          <div className= ' border-2 border-white w-7 h-7 rounded-full text-center align-middle'>X</div>
          <div className= ' border-2 border-white w-7 h-7 rounded-full text-center align-middle'>Y</div>
          <div className= ' border-2 border-white w-7 h-7 rounded-full text-center align-middle'>Z</div>
      ...
      {loading ? (
        ...
        <div>
          <div className='font-serif italic text-4xl flex justify-center border-b border-slate-400 border-opacity-25'>Your search result: Хайснаа ол хха </div>
          <ul className='my-5'>
        ...
        <div>
          ...
          <div className='flex flex-row space-x-3 justify-between my-8'>
            <div className='h-44 w-[310px]'>
              <p className=''>An open, crowd-sourced database of drinks and cocktails from around the world.
